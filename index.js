...
// Create a variable 
//called user1 with the keys username (any string), password (any string), friendCount (any number), and isOnline (false).
let user1 = {
  username:"alymaOO",
  password:"yineriandanaforever",
  friendCount:10,
  isOnline:false
...
let user=prompt("enter your passowrd!")
...
let user=prompt("eneter a status")
